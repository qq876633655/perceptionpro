...
# ════════════════════════════════════════════════════════════════════
# 通用 Env / Version Serializer 工厂（所有模块复用）
# ════════════════════════════════════════════════════════════════════
...
# ── Per（感知）──────────────────────────────────────────────────────
PerEnvSerializer           = make_env_serializer(PerEnv)
PerVersionCreateSerializer = make_version_create_serializer(PerVersion)
PerVersionUpdateSerializer = make_version_update_serializer(PerVersion)
PerVersionListSerializer   = make_version_list_serializer(PerVersion, PerEnv)
...
# ── At（自动化）──────────────────────────────────────────────────────────────────
AtEnvSerializer           = make_env_serializer(AtEnv)
AtVersionCreateSerializer = make_version_create_serializer(AtVersion)
AtVersionUpdateSerializer = make_version_update_serializer(AtVersion)
AtVersionListSerializer   = make_version_list_serializer(AtVersion, AtEnv)
